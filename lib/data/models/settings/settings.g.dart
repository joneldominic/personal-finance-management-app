...
void _settingsSerialize(
  ...
  writer.writeBool(offsets[0], object.isLightTheme);
}
...
Settings _settingsDeserialize(
  ...
  final object = Settings(
    id: id,
    isLightTheme: reader.readBoolOrNull(offsets[0]),
  );
  return object;
}
...
extension SettingsQueryFilter on QueryBuilder<Settings, Settings, QFilterCondition> {
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> isLightThemeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
...
extension SettingsQuerySortBy on QueryBuilder<Settings, Settings, QSortBy> {
  QueryBuilder<Settings, Settings, QAfterSortBy> sortByIsLightTheme() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLightTheme', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> sortByIsLightThemeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLightTheme', Sort.desc);
    });
  }
}
...
extension SettingsQuerySortThenBy on QueryBuilder<Settings, Settings, QSortThenBy> {
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> thenByIsLightTheme() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLightTheme', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> thenByIsLightThemeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLightTheme', Sort.desc);
    });
  }
...
extension SettingsQueryProperty on QueryBuilder<Settings, Settings, QQueryProperty> {
  ...
  QueryBuilder<Settings, bool?, QQueryOperations> isLightThemeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isLightTheme');
    });
  }
}
